  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-950/80 backdrop-blur-md overflow-y-auto no-print">
      <motion.div
        ...
        className="w-full max-w-2xl bg-slate-900 border border-white/10 rounded-3xl overflow-hidden shadow-2xl flex flex-col max-h-[92vh]"
        dir="rtl"
      >
        {/* Header */}
        <div className="p-4 sm:p-5 border-b border-white/10 flex justify-between items-center bg-slate-950/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base font-black text-white">إصدار التقارير المالية وكشوف الحساب</h3>
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-5 custom-scrollbar">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                <div className="flex justify-between items-center mb-1">
                  <span className="text-xs font-black text-amber-400">ملخص تنفيذي</span>
                  {reportType === 'summary' && <CheckCircle2 size={16} className="text-amber-500" />}
                </div>
              ...
              >
                <div className="flex justify-between items-center mb-1">
                  <span className="text-xs font-black text-amber-400">كشف قيود تفصيلي</span>
                  {reportType === 'detailed' && <CheckCircle2 size={16} className="text-amber-500" />}
                </div>
                <p className="text-[10px] text-slate-400 font-medium leading-relaxed">
          ...
          <div className="space-y-2">
            ...
            {datePreset === 'custom' && (
              <div className="grid grid-cols-2 gap-3 p-3 bg-slate-950/60 rounded-2xl border border-white/5 mt-2">
                <div>
          ...
          <AnimatePresence>
            {showPreview && (
              <motion.div
                ...
                className="overflow-hidden rounded-2xl border border-amber-500/30 bg-white"
              >
        ...
        {/* Footer Actions */}
        <div className="p-4 sm:p-5 border-t border-white/10 bg-slate-950/70 flex flex-col sm:flex-row gap-3">
          <button
            type="button"
            onClick={handlePrint}
            className="flex-1 py-3 px-4 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-black text-xs rounded-2xl flex items-center justify-center gap-2 shadow-lg shadow-amber-500/20 active:scale-98 transition-all"
          >
            <Printer size={16} />
          ...
          <button
            ...
            className="flex-1 py-3 px-4 bg-slate-800 hover:bg-slate-700 text-white font-black text-xs rounded-2xl flex items-center justify-center gap-2 border border-slate-700 active:scale-98 transition-all"
          >
