...
export const generateAndSharePDF = async (
  ...
  // Deprecated: html2canvas and jsPDF were removed because they do not support Arabic text.
  // Instead, the app uses window.print() and asks the user to Save as PDF from their device print dialog.
  alert('لطباعة التقرير أو حفظه كملف PDF، يرجى استخدام نافذة الطباعة الخاصة بجهازك.');
  window.print();
};
